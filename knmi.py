...
arrayWithBirds = ['Roodkeelduiker','Fuut','Jan-van-gent','Aalscholver','rietgans spec.','Toendrarietgans','Kleine Rietgans','Kolgans','Grauwe Gans','Brandgans','Rotgans','Nijlgans','Bergeend','Smient','Wilde Eend','Tafeleend','Kuifeend','Zwarte Zee-eend','Buizerd','Kraanvogel','Scholekster','Goudplevier','Kievit','Wulp','Dwergmeeuw','Kokmeeuw','Stormmeeuw','Kleine Mantelmeeuw','Zilvermeeuw','Grote Mantelmeeuw','Drieteenmeeuw','Grote Stern','Visdief','Zeekoet','Holenduif','Houtduif','Gierzwaluw','Veldleeuwerik','Oeverzwaluw','Boerenzwaluw','Huiszwaluw','Graspieper','gele kwikstaart spec.','Gele Kwikstaart','witte kwikstaart spec.','Witte Kwikstaart','Kramsvogel','Zanglijster','Koperwiek','Pimpelmees','Koolmees','Kauw','Spreeuw','Ringmus','Vink','Keep','Groenling','Sijs','Kneu','Kruisbek','Rietgors','Noordse Stern/Visdief','Alk/Zeekoet','anser spec.','gans spec.','Vink/Keep']

def getNeededVariables(arrayWithVariables):
    path = os.path.join(os.getcwd(), 'pwsvogel/pwsvogelmodel')
    ...
    predictionsDataframe = pandas.DataFrame(predictions)
    predictionsDataframe.columns = arrayWithBirds
    Get_data.exportFile(predictionsDataframe, 'predictions.csv')
    return predictions
